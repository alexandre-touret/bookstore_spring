...
Let's inspect the code of link:rest-book/src/main/java/org/techforum/spring/maintenance/controller/MaintenanceController.java[`MaintenanceController.retreiveInMaintenance()`] to see how the HealthCheck probe is developped.
...
Let's browse the code of link:rest-book/src/main/java/org/techforum/spring/maintenance/filter/CheckMaintenanceFilter.java[`CheckMaintenanceFilter.java`] and see how this answer is provided using a JAX-RS filter.
...
* _link:rest-book/src/main/java/org/techforum/spring/book/controller/BookController.java[`BookController.java`]_: Spring MVC, SpringDoc, Swagger, Actuator
...
* `link:rest-book/src/main/java/org/techforum/spring/book/controller/BookController.java[BookController.java]`
* `link:rest-book/src/main/java/org/techforum/spring/GlobalExceptionHandler.java[GlobalExceptionHandler.java]̀
...
Browse link:rest-book/src/main/java/org/techforum/spring/book/service/BookService.java[`BookService.java`] , link:rest-book/src/main/java/org/techforum/spring/book/BookConfiguration.java[`BookConfiguration.java`] and `link:rest-book/src/main/resources/application.yml[application.yml]` to see how it is coded:

* `link:rest-book/src/main/resources/application.yml[application.yml]`: a bit of configuration to define the target URL
* link:rest-book/src/main/java/org/techforum/spring/book/service/BookService.java[`BookService.java`] : the rest template is injected in the constructor
* link:rest-book/src/main/java/org/techforum/spring/book/BookConfiguration.java[`BookConfiguration.java`]: creates the restTemplate instance
...
* `CircuitBreakerFactory` usage on `link:rest-book/src/main/java/org/techforum/spring/book/service/BookService.java[BookService.registerBook()]`
* `Resilience4JCircuitBreakerFactory` (global and specific) configuration on link:rest-book/src/main/java/org/techforum/spring/book/BookConfiguration.java[`BookConfiguration`]
* Catch `ApiCallTimeoutException` on link:/home/littlewing/dev/src/techforum_spring/rest-book/src/main/java/org/techforum/spring/GlobalExceptionHandler.java[`GlobalExceptionHandler`]
...
Browse `link:rest-book/src/main/java/org/techforum/spring/book/controller/BookController.java[BookController.java]` to see how it is implemented
...
Browse `link:rest-book/src/main/java/org/techforum/spring/book/controller/BookController.java[BookController.java]` to see how Metrics is coded.

## Demo 9: Testing

Browse link:rest-book/src/test/java/org/techforum/spring/book/controller/BookControllerIT.java[`BookControllerIT.java`] to see how to test using H2 in memory database and link:https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/test/web/client/MockRestServiceServer.html[`MockRestServiceServer`]
